...
c1,c2=s.columns(2)
with c1:
    a1=s.number_input("what is the price of bitcoin in dollers on 1st jan 2024 with 2 floating point?")
with c2:
    a2=s.number_input("what is the value of phi or golden ratio with 2 floating point?")
